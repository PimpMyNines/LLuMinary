...
python -m llmhandler.cli.classify list_configs /path/to/config/dir
...
```python
from llmhandler.models.base import LLM
from llmhandler.models.router import register_provider
