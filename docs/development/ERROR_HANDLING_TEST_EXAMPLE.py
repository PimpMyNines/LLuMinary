...
This demonstrates how to properly test error handling in LLM providers.
"""
import pytest
...
class TestOpenAIErrorHandling:
    ...
    def test_rate_limit_error_with_retry(self, mock_openai_client):
    ...
    def test_content_error(self, mock_openai_client):
        ...
        mock_openai_client.return_value.chat.completions.create.return_value = response_mock
    ...
    def test_server_error(self, mock_openai_client):
        """Test handling of server errors."""
        import openai
        
        # Mock a server error
        server_error = openai.APIError("Internal server error")
        mock_openai_client.return_value.chat.completions.create.side_effect = server_error
    ...
    def test_timeout_error(self, mock_openai_client):
        ...
        mock_openai_client.return_value.chat.completions.create.side_effect = timeout_error
    ...
    def test_tool_error(self, mock_openai_client):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConfigurationError, {"provider": "test-provider", "details": {"param": "value"}}),
...
def test_exception_attributes(exception_class, expected_attributes):
