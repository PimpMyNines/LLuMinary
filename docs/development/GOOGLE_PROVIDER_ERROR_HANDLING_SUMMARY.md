...
This document summarizes the implementation of standardized error handling in the Google LLM provider (`google.py`).
...
1. **Error Mapping System**
   - Created `_map_google_error` method to translate Google API exceptions to LLMHandler custom exception types
...
1. **src/llmhandler/models/providers/google.py**
