...
class CohereLLM(LLM):
            ...
            if self.supports_image_input() and message_type == "human":
                ...
                for img_url in message.get("image_urls", []):
                    try:
                        ...
                        print(f"Warning: Failed to add image URL {img_url}: {str(e)}")
    ...
    def _raw_generate(
        ...
        try:
            ...
            # Handle other errors
            raise LLMMistake(
                f"Error generating text with Cohere: {str(e)}",
    ...
    def embed(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ValueError(f"Error getting embeddings from Cohere: {str(e)}")
    ...
    def rerank(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ValueError(f"Error reranking documents with Cohere: {str(e)}")
