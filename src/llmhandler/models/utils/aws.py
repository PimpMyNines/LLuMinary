...
def get_secret(secret_id: str, required_keys: list[str] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        try:
            ...
            raise Exception(
                f"Failed to retrieve secret '{secret_id}' from AWS Secrets Manager: {str(e)}"
            )
        ...
        try:
            ...
            raise Exception(f"Failed to parse secret '{secret_id}': {str(e)}")
        ...
        raise Exception(f"Error accessing credentials: {str(e)}")
