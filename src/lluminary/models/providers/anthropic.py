...
class AnthropicLLM(LLM):
    ...
    def _raw_generate(
        ...
        Raises:
            LLuMinaryError: Appropriate error subtype based on the failure
        """
        try:
    ...
    def _map_anthropic_error(
        ...
        """
        Map Anthropic-specific errors to standardized LLuMinary error types.
    ...
    def stream_generate(
        ...
        Raises:
            LLuMinaryError: With appropriate error subtype based on the failure
        """
        try:
