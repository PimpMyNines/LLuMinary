...
MODEL_MAPPINGS: Dict[str, Dict[str, str]] = {
    ...
    "gemini-2.0-pro": {"provider": "google", "model": "gemini-2.0-pro-exp-02-05"},
...
def register_model(friendly_name: str, provider_name: str, model_id: str) -> None:
    """
    ...
    MODEL_MAPPINGS[friendly_name] = {"provider": provider_name, "model": model_id}
