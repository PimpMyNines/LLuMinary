# LLMHandler Test Suite

This directory contains tests for the LLMHandler library. The tests are organized to provide comprehensive coverage of the library's functionality while keeping test execution efficient.
...
See `tests/test_data/example_test.py` for a simple example of how to create your own tests with LLMHandler.
...
1. Use the smallest, least expensive models when possible (e.g., claude-haiku-3.5 instead of claude-opus-3.5)
