...
from src.lluminary.models.providers.provider_template import ProviderNameLLM
from src.lluminary.models.router import register_provider
...
class TestProviderTemplateRegistration:
    ...
    def test_provider_registration(self):
        ...
        from src.lluminary.models.router import MODEL_TO_PROVIDER_MAP, PROVIDERS
