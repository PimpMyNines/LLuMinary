...
class TestGoogleStreamingDirect:
    ...
    def test_stream_generate_basic_with_patched_imports(self, mock_auth):
        ...
        def mock_stream_generate(event_id, system_prompt, messages, 
                                max_tokens=1000, temp=0.0, functions=None, callback=None):
    ...
    def test_stream_generate_error_handling(self, mock_auth):
        ...
        # Patch the stream_generate method
        with patch.object(llm, "stream_generate", side_effect=mock_stream_generate_error):
