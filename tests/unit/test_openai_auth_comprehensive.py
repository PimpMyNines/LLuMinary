...
from src.llmhandler.exceptions import AuthenticationError, ConfigurationError
...
@patch("src.llmhandler.models.providers.openai.get_secret")
...
def test_auth_with_env_variable_fallback(mock_get_secret):
    ...
    with patch.dict(os.environ, {"OPENAI_API_KEY": "env-api-key"}), \
         patch("src.llmhandler.models.providers.openai.OpenAI") as mock_openai:
...
def test_auth_with_api_key_and_base_from_env(mock_get_secret):
    ...
    with patch.dict(os.environ, env_vars), \
        ...
        mock_openai.assert_called_once_with(
            api_key="env-api-key",
            base_url="https://env-openai-api.example.com/v1"
        )
