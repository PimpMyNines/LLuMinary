...
def test_multiple_images_in_message(openai_llm):
    ...
    with patch.object(openai_llm, "_encode_image", return_value="base64_local_image"), \
...
def test_image_cost_calculation(openai_llm):
    ...
    # Setup mocks
    with patch.object(openai_llm, "_encode_image", return_value="base64_encoded"), \
         patch.object(openai_llm, "_calculate_image_tokens", return_value=300), \
         patch.object(openai_llm, "client") as mock_client:
