...
def test_token_count_from_messages(openai_llm):
    ...
    # Test longer message
    long_message = [{"role": "user", "content": "This is a longer message that should use more tokens " * 10}]
...
def test_image_token_calculation(openai_llm):
    ...
    assert openai_llm._calculate_image_tokens(800, 600, "high") > openai_llm._calculate_image_tokens(800, 600, "low")
