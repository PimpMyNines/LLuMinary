        ...
        with patch.object(openai_llm, "MAX_IMAGE_SIZE", 2048), patch.object(
            ...
            test_cases = [
                ...
                (
                    ...
                    2000,
                    1785,
                ),  # Should scale down to 2048x1365, 4x3 tiles (12*170) + base cost (85)
                (
                    300,
                    300,
                    255,
                ),  # Small image, scales up to 768x768, 2x2 tiles (4*170) + base cost (85)
            ]
            ...
            for width, height, expected_tokens in test_cases:
                ...
                ), f"Image {width}x{height} expected {expected_tokens} tokens, got {tokens}"
